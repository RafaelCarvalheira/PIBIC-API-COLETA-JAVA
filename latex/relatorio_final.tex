...
\begin{table}[H]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{4.6cm} c c}
        ...
        \midrule
        Cliente compartilhado & um par de tarefas, demandas somadas & um par de tarefas por transportadora \\
        Vínculo entre entrega e coleta & mesmo veículo & mesma transportadora \\
        Alocação do cliente compartilhado & \multicolumn{2}{c}{decidida pela busca (\textit{skills})} \\
        Partidas (\textit{multi-start}) & \multicolumn{2}{c}{10} \\
        Iterações por partida & \multicolumn{2}{c}{1.000} \\
        Esforço total (iterações) & \multicolumn{2}{c}{10.000} \\
        Threads & \multicolumn{2}{c}{4} \\
        Troca de veículo & \multicolumn{2}{c}{habilitada} \\
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{4.2cm} | c c c | c c c}
        ...
        Sem simultaneidade & +0,71 & 26 & 33,0$\times$ & +1,06 & 31 & 27,7$\times$ \\
...
\noindent{\footnotesize \textit{Nota: ``Iguais'' indica o número de instâncias em que o Jsprit reproduziu exatamente o custo do método exato.}}
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{5.0cm} c c c c c c c}
        ...
        Sem simultaneidade (colaborativo) & +0,17 & +0,70 & +0,99 & +0,33 & +2,24 & +0,89 & 57/100 \\
